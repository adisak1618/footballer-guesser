...
// Issue #27 — replaces the deleted /new host-setup screen. The host enters
// only their display name on the landing; the room is created with a default
// category + default max_rounds, and the host edits both in the lobby via
// the shared RoomSetupPanel.

export function CreateInsiderRoomButton() {
  ...
  return (
    <>
      <button
        ...
        data-testid="insider-create-room-cta"
      ...
      {open && (
        <div
          role="dialog"
          aria-modal="true"
          aria-labelledby="create-insider-room-title"
          data-testid="insider-create-room-dialog"
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              <input
                ...
                aria-describedby={error ? "create-insider-room-error" : undefined}
                disabled={isPending}
                data-testid="insider-create-room-name-input"
              ...
              <div className="flex items-center justify-between text-xs text-on-dark-muted">
                <span aria-live="polite">
                  {error ? (
                    <span id="create-insider-room-error" className="text-error">
                      {error}
                    </span>
                  ) : (
                    "1–20 ตัวอักษร"
            ...
            <div className="flex flex-col gap-2 pt-2">
              <button
                type="submit"
                disabled={isPending}
                data-testid="insider-create-room-submit"
