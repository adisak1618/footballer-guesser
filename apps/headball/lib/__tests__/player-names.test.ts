...
describe("findPrefixMatches", () => {
  ...
  it("PLAYER_NAMES bundles the seed dictionary", () => {
    // Auto-generated by scripts/build-seed.ts from data/seed/players.json.
    // Size grows whenever the Wikidata seed is refreshed; assert lower bound.
    expect(PLAYER_NAMES.length).toBeGreaterThanOrEqual(100)
  })
})
